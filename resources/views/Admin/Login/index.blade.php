...
<body style="background-color:#DAE8E5;background-image: url('{{ asset('img/seasl.jpg') }}');">
    <div class="all-wrap" >
      <div class="all">
        <div class="yarn"></div>
        <div class="cat-wrap">
    ...
    <div style="margin:15% 60%;width:400px;height:380px;background-color:#ffffff;border-radius:5px;">
        <div style="margin: 0 auto;width:50%;">
            ...
            <div class="layui-input-inline" style="margin-top:20px;width:220px;">
                ...
                <img id="verify_img" style="float: right;" src="{{url('admin/getVerify')}}" alt="" onclick="this.src='{{url("admin/getVerify")}}?'+Math.random()" />
            </div>
            <div class="layui-input-inline" style="margin-top:20px">
...
$(document).ready(function(){
     ...
     */
    function newcode(){
        $('#verify_img').attr('src','{{ url("admin/getVerify") }}?'+Math.random());
    }
});
</script>