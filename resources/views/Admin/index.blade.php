...
<head>
    ...
    <title>{{ Config::get('constants.SYSTEM_NAME') }}</title>
...
<body class="kit-theme">
    <div class="layui-layout layui-layout-admin kit-layout-admin">
        <div class="layui-header">
            <div class="layui-logo">{{ Config::get('constants.SYSTEM_TITLE') }}</div>
            ...
            <ul class="layui-nav layui-layout-right kit-nav">
                ...
                <li class="layui-nav-item">
                    <a href="javascript:;">
                        <img src="{{ Config::get('constants.SYSTEM_ADDRESS') }}{{ Session::get('admin_header_img') }}" class="layui-nav-img"> {{ Session::get('admin_rel_name') }}
                    </a>
    ...
    <!-- <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right">
                <li class="layui-nav-item">
                    <a href="javascript:;">
                        <img src="{{ Config::get('constants.SYSTEM_ADDRESS') }}{{ Session::get('admin_header_img') }}" class="layui-nav-img">
                        {{ Session::get('admin_rel_name') }}
                    </a>
                    <dl class="layui-nav-child">
                        <dd><a href="">基本资料</a></dd>
                        <dd><a href="">安全设置</a></dd>
        ...
        <div class="layui-footer" style="text-align: center;">
            {{ Config::get('constants.SYSTEM_BUTTON') }}
        </div>
    </div>
 -->

<script src="{{ asset('Layui/layui.all.js') }}" type="text/javascript" charset="utf-8" ></script>
...
$('.login_out').click(function(){
    let _url = "{{ url('admin/loginout') }}",_data = {};
    $.ajax({
        type: "GET",
        url: _url,
        data: _data,
